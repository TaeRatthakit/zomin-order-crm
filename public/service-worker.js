const CACHE_NAME = "growup-pilot-pwa-v113-order-form-no-packages-v1";
const CORE_ASSETS = [
  "/",
  "/index.html",
  ...
  "/styles.css?v=20260719-order-form-no-packages-v1",
  "/app.js?v=20260719-order-form-no-packages-v1",
