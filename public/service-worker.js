const CACHE_NAME = "growup-pilot-pwa-v91-permission-accordion-ui";
const CORE_ASSETS = [
  "/",
  "/index.html",
  ...
  "/styles.css?v=20260711-permission-accordion-ui-v1",
  "/app.js?v=20260711-permission-accordion-ui-v1",
