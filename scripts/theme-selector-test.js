...
assert(html.indexOf('const preference = "system"') < html.indexOf("/styles.css?v=20260722-customer-table-light-v2"), "theme bootstrap must default to System before stylesheet load");
...
assert(html.includes('/app.js?v=20260722-customer-table-light-v2'), "app asset version must be bumped");
...
assert(serviceWorker.includes('growup-pilot-pwa-v125-customer-table-light-v2'), "service worker cache name must be bumped");
assert(serviceWorker.includes('/styles.css?v=20260722-customer-table-light-v2'), "service worker must cache current stylesheet");
assert(serviceWorker.includes('/app.js?v=20260722-customer-table-light-v2'), "service worker must cache current app bundle");
